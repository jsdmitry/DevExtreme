...
QUnit.test("cellsArray generating", function(assert) {
    ...
    assert.deepEqual(cells[0][0], { cellIndex: "A1", style: 0, type: "b", value: true }, "cell1 in first row data");
    assert.deepEqual(cells[0][1], { cellIndex: "B1", style: 1, type: "s", value: 0 }, "cell2 in first row data");
    assert.deepEqual(cells[0][2], { cellIndex: "C1", style: 2, type: "n", value: 12 }, "cell3 in first row data");
    assert.deepEqual(cells[0][3], { cellIndex: "D1", style: 3, type: "n", value: 41709.5 }, "cell4 in first row data");
});
